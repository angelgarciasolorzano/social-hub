    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent>
        ...
        <div className="flex flex-col gap-6">
          <div className="flex min-w-0 items-start gap-2.5 rounded-xl border p-4 shadow-xs">
            <div className="flex h-14 w-14 shrink-0 rounded-md bg-violet-100/50 p-2 dark:bg-violet-900/20">
